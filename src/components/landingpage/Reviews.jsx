...
const Reviews = () => {
  return (
    <div>
      ...
      <div className="container pt-16  grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 px-4 md:px-0 gap-16 md:gap-4">
        <div className="bg-[#FFFF] relative border rounded-xl shadow-lg hover:shadow-xl">
          ...
          <div className="max-w-xs mx-auto py-20 px-8">
            ...
            <h1 className="absolute top-[20rem] md:top-[24rem] left-[7rem] md:left-[9rem]">Louisville</h1>
          </div>
        </div>
        <div className={`bg-[#FFFF] relative border rounded-xl shadow-lg hover:shadow-xl`}>
          <img
          ...
          <div className="max-w-xl mx-auto py-20 px-8">
            ...
            <h1 className="absolute top-[27.5rem] md:top-[24rem] left-[8rem] md:left-[9rem]">Dallas</h1>
          </div>
        </div>
        <div className="bg-[#FFFF] relative border rounded-xl shadow-lg hover:shadow-xl">
          <img
          ...
          <div className="max-w-xs mx-auto py-20 px-8">
            ...
            <h1 className="absolute top-[20rem] md:top-[24rem] left-[7rem] md:left-[9rem]">Bradenton</h1>
          </div>
        </div>
      </div>
    </div>
